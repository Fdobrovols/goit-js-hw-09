...
function changeFieldValue(timeLeft = null) 
{
  ...
  minutesField.textContent = addLeadingZero(convertMs(timeLeft)?.minutes) ?? '00';
  secondsField.textContent = addLeadingZero(convertMs(timeLeft)?.seconds) ?? '00';
}
